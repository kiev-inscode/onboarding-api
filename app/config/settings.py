...
SECRET_KEY = 'django-insecure-u&*y8zkad8=k(44d-9w(nb(*$q!zzri2idd(==2*vfurs!pa#z'
...
MIDDLEWARE = [
    ...
    "django_inscode.middlewares.ExceptionHandlingMiddleware"
]
...
DATABASES = {
    'default': {
        ...
        "PORT": env.get_value("POSTGRES_PORT", default=""),
    }
}
